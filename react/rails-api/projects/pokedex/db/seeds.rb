...
def find_unique_item(pokemon)
  ...
  while Pokemon
          .find(pokemon.id)
          .items
          .any? { |item| item.image_url == candidate }
    candidate = candidate_item
  end
  candidate
end
...
ActiveRecord::Base.transaction do
  ...
  pokemon = {
    ...
    '23' => {
      ...
      'defense' => 55,
      'poke_type' => 'electric',
      'moves' => %w[thundershock thunderbolt]
    },
    '24' => {
      'name' => 'Sandshrew',
      'attack' => 75,
    ...
    '36' => {
      ...
      'defense' => 60,
      'poke_type' => 'bug',
      'moves' => %w[psybeam psychic confusion gust]
    },
    '37' => {
      'name' => 'Diglett',
      'attack' => 55,
    ...
    '38' => {
      ...
      'defense' => 50,
      'poke_type' => 'ground',
      'moves' => %w[scratch slash earthquake]
    },
    '39' => {
      'name' => 'Meowth',
      'attack' => 45,
    ...
    '48' => {
      ...
      'defense' => 45,
      'poke_type' => 'psychic',
      'moves' => %w[confusion psybeam psychic]
    },
    '49' => {
      'name' => 'Machop',
      'attack' => 80,
    ...
    '61' => {
      ...
      'defense' => 70,
      'poke_type' => 'electric',
      'moves' => %w[tackle thundershock spark]
    },
    '62' => {
      'name' => 'Magneton',
      'attack' => 60,
    ...
    '74' => {
      ...
      'defense' => 45,
      'poke_type' => 'psychic',
      'moves' => %w[pound confusion headbutt]
    },
    '75' => {
      'name' => 'Hypno',
      'attack' => 73,
      'defense' => 70,
      'poke_type' => 'psychic',
      'moves' => %w[pound confusion headbutt psychic]
    },
    '76' => {
      'name' => 'Krabby',
      'attack' => 105,
    ...
    '101' => {
      ...
      'defense' => 57,
      'poke_type' => 'electric',
      'moves' => %w[thunderpunch swift thunderbolt thunder]
    },
    '102' => {
      'name' => 'Magmar',
      'attack' => 95,
    ...
    '109' => {
      ...
      'defense' => 60,
      'poke_type' => 'electric',
      'moves' => %w[tackle thundershock thunder]
    },
    '110' => {
      'name' => 'Flareon',
      'attack' => 130,
      'defense' => 60,
      'poke_type' => 'fire',
      'moves' => %w[flamethrower ember bite smog]
    },
    '111' => {
      'name' => 'Porygon',
      'attack' => 60,
    ...
    '124' => {
      ...
      'defense' => 90,
      'poke_type' => 'psychic',
      'moves' => %w[confusion swift psychic]
    },
    '125' => {
      'name' => 'Mew',
      'attack' => 100,
